...
def create_app(
    *,
        ...
        try:
            ...
            if dyn_path.exists():
                for filename in os.listdir(dyn_path):
                    ...
                    if full_path.is_file() and lower_name.endswith(
                        (
                            ".mp4",
                            ".png",
                            ".jpg",
    ...
    _TTS_MODEL_DIR = os.environ.get("LTX_TTS_MODEL_DIR", r"F:\LTX2.3\VoxCPM2")
    ...
    async def route_tts_status():
        ...
        try:
            ...
            model_dir_exists = os.path.isdir(_TTS_MODEL_DIR)
            return {
